...
class MainWindow(QMainWindow):
    ...
    def _build_project_toolbar(self) -> None:
        ...
        open_logs_action.triggered.connect(self._on_open_logs_triggered)

        import_subtitle_action = QAction("Import Subtitle", self)
        import_subtitle_action.setShortcut(QKeySequence("Ctrl+Shift+I"))
        import_subtitle_action.triggered.connect(self._on_import_subtitle_triggered)

        toolbar.addAction(load_action)
        toolbar.addAction(save_action)
        toolbar.addAction(save_as_action)
        toolbar.addAction(self._export_action)
        toolbar.addAction(import_subtitle_action)
    ...
    def _build_timeline_toolbar(self) -> None:
        ...
        playhead_start_action = QAction("Playhead Start", self)
        playhead_start_action.setShortcut(QKeySequence("Ctrl+Home"))
        playhead_start_action.triggered.connect(self._on_playhead_start_triggered)

        prev_frame_action = QAction("Prev Frame", self)
        prev_frame_action.setShortcut(QKeySequence("Alt+Left"))
        prev_frame_action.triggered.connect(self._on_prev_frame_triggered)

        next_frame_action = QAction("Next Frame", self)
        next_frame_action.setShortcut(QKeySequence("Alt+Right"))
        next_frame_action.triggered.connect(self._on_next_frame_triggered)
        ...
        toolbar.addAction(playhead_start_action)
        ...
        add_text_action.setShortcut(QKeySequence("Ctrl+Shift+T"))
        add_text_action.triggered.connect(self._on_add_text_triggered)
        toolbar.addAction(add_text_action)

        self._snap_action = QAction("Snap", self)
